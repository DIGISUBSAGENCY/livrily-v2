...
interface PageMetadataOptions {
  title: string
  description: string
  // Pages transactionnelles/privées (profil, vérification...) : pas de
  // valeur à être indexées, mais restent crawlable (follow) — outil correct
  // pour ça, différent de robots.ts qui bloque la découverte de la section
  // entière /admin.
  noIndex?: boolean
}
...
// une page précise (demande de voyage...) sur WhatsApp afficherait le titre
// générique du site plutôt que le titre de la page.
