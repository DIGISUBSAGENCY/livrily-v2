...
export function BoostPayment({ itemType, itemId, bankInfo, priceTnd, durationDays, currentBoostedUntil }: BoostPaymentProps) {
    ...
    <div className="space-y-3 rounded-lg border border-amber-200 bg-amber-50/50 p-3">
      <div>
        <p className="text-sm font-medium text-slate-900">
          Mets cet item en avant pour {formatTND(priceTnd)}, {durationDays} jour{durationDays > 1 ? 's' : ''}
        </p>
