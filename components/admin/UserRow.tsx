...
export function UserRow({ user, ordersCount }: UserRowProps) {
  return (
    <Link href={`/admin/utilisateurs/${user.id}`}>
      <div className="grid grid-cols-[1.5fr_1fr_auto_1fr_auto_1fr] items-center gap-3 border-b border-slate-100 px-1 py-3 text-sm last:border-0 hover:bg-slate-50">
        ...
        <p className="text-slate-600">{ordersCount}</p>
